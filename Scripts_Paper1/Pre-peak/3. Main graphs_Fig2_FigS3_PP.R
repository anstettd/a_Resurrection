...
#SLA Graphs
fullmod.SLA <- lmer(SLA ~ Region*Year*Drought + (1|Family) + (1|Block) + (1|Site.Lat), data=y6)
...
SxYD.exp<- lmer(Experiment_Date ~ Region*Year + Drought + (1|Family) + (1|Block) + (1|Site.Lat), data=y6)
...
#SxY.exp<- lmer(Experiment_Date ~ Region*Year + (1|Family) + (1|Block), data=y6)
#lrtest(SxYD.exp,SxY.exp) #Region*Year + Drought Supported

#Date of Flowering Graphs
finalmod.exp <- lmer(Experiment_Date ~ Region*Year*Drought + (1|Family) + (1|Block) + (1|Site.Lat), data=y6)
...
SxYD.wc<- lmer(Water_Content ~ Region*Year + Drought + (1|Family) + (1|Block) + (1|Site.Lat), data=y6)
lrtest(noDxY.wc,SxYD.wc) #SxYD.wc supported
SxY.wc<- lmer(Water_Content ~ Region*Year + (1|Family) + (1|Block) + (1|Site.Lat), data=y6)
...
#SxY.A<- lmer(Assimilation ~ Region*Year + (1|Family) + (1|Block), data=y6)
...
#noDrought.A <- lmer(Assimilation ~ Region + Year + (1|Family) + (1|Block), data=y6)
#lrtest(nox.A, noDrought.A) # no interactions model significantly better. Retain drought in model.

#noYear.A <- lmer(Assimilation ~ Region + Drought + (1|Family) + (1|Block), data=y6)
...
DxYS.gs<- lmer(Stomatal_Conductance ~ Drought*Year + Region +  (1|Family) + (1|Block) + (1|Site.Lat), data=y6)
lrtest(noSxY.gs,DxYS.gs) # Remove Site X Drought
#no interactions
nox.gs <- lmer(Stomatal_Conductance ~ Region + Year + Drought + (1|Family) + (1|Block) + (1|Site.Lat), data=y6)
...
###############################
#no.main.gs <- lmer(Stomatal_Conductance ~ (1|Family) + (1|Block), data=y6)
#lrtest(Drought.gs, no.main.gs) # Drought better than nothing

#Stomatal Conductance Graphs
finalmod.gs <- lmer(Stomatal_Conductance ~ Region*Year*Drought + (1|Family) + (1|Block) + (1|Site.Lat), data=y6)
