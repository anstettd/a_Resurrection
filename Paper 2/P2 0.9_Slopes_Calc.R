...
### Flowering_Dry ###
fullmod.cmd.exp <- lmer(Experiment_Date.s ~ Site.Lat*Year*Drought + (1|Family) + (1|Block) + (1|Year), 
                        control=lmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=100000)), data=y5) # mixed 3-way model
