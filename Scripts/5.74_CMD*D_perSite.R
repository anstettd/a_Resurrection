...
CMDA.D.exp <- lmer(Experiment_Date ~ CMD.anom.s*Drought + (1|Family) + (1|Block), data=y4)
CMDA_1.D.exp <- lmer(Experiment_Date ~ CMD.anom.1.s*Drought + (1|Family) + (1|Block), data=y4)
lrtest(CMDA.D.exp,CMDA_1.D.exp) #
