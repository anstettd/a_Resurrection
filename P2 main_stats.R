...
#Trait ~ Year*Treatment + (pop|Year) + (pop|Treatment) + (1|Block) + (1| Family)
#Trait ~ Year*Treatment + (1|pop) + (1|Block) + (1| Family)
...
fullmod.SLA <- lmer(SLA ~ Year*Drought + (Site.Lat|Year) + (Site.Lat|Drought)+ (1|Family) + (1|Block),
                    control=lmerControl(optimizer="bobyqa"), data=y5)
# drop 3way
